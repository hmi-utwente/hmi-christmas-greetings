 ...
 * 
 */
public class Hue2MiddlewareRealizerStarter
{
    ...
    public Hue2MiddlewareRealizerStarter(JFrame j, String spec) throws IOException
    {
    ...
    public static void main(String[] args) throws IOException
    {
        ...
        Hue2MiddlewareRealizerStarter demo = new Hue2MiddlewareRealizerStarter(new JFrame("AsapRealizer Cristmas Greetings - Hue"), spec);
    }
}
