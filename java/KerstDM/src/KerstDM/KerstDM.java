...
public class KerstDM implements ErrorHandler {
	...
	private static String inTopicToneelStuk;
	private static String outTopicASAP1;
	private static String outTopicASAP2;
	private static String inTopicASAP1Feedback;
	private static String inTopicASAP2Feedback;
	...
	static KerstDM testqaresponder = new KerstDM(apolloIP, apolloPort);
	...
	Gson gsonParser;
	QueueProcessingThreat qpt;	
	
	
    public KerstDM(String apolloIP, int apolloPort){
        ...
        try {
			//topiclistener binnenkomend toneelstuk
			con.subscribe(inTopicToneelStuk, true);
			
			
			
			con.addMessageHandler(inTopicToneelStuk, new MessageHandler() {
			...
			//topic feedback asap agent 1
			con.subscribe(inTopicASAP1Feedback, true);
			con.addMessageHandler(inTopicASAP1Feedback, new MessageHandler() {
			...
			//topic feedback asap agent 2
			con.subscribe(inTopicASAP2Feedback, true);
			con.addMessageHandler(inTopicASAP2Feedback, new MessageHandler() {
    ...
    private static void testPatternFinding () {
    	String testMessage = "<syncPointProgress characterId=\"CleVR\" id=\"bml1481818873818:speech1:end\" time=\"0.4440915286540985\" globalTime=\"4216.62939453125\" bmla:posixTime=\"1481818875529\" xmlns=\"http://www.bml-initiative.org/bml/bml-1.0\" xmlns:bmla=\"http://www.asap-project.org/bmla\"></syncPointProgress>";
    	
    	if (isBMLSpeechEndIs(testMessage)) {
    ...
    private static void testJsonParsing () {
    	String testingJsonStr = "{\"requests\": [{agent = \"/topic/agent1BMLRequest\", agentFeedback = \"/topic/agent1BMLFeedback\", bml=\"....\"},    	{agent = \"/topic/agent1BMLRequest\", agentFeedback = \"/topic/agent1BMLFeedback\", bml=\"....\"},    	{agent = \"/topic/agent1BMLRequest\", agentFeedback = \"/topic/agent1BMLFeedback\", bml=\"....\"}    	]    	}";
    	
    	Gson gson = new Gson();
    	Requests requests = gson.fromJson(testingJsonStr,Requests.class);
    	
    	System.out.println("JSON cool!");
	...
	public static void main(String[] args){
		...
		System.out.println("KerstDM Message switcher blabla");
...
//				con.send(jsonthing, outTopicASAP1);
//			//}
...
//    }
	...
	private static boolean isBMLSpeechEndIs (String str ){		
		boolean found = false;
